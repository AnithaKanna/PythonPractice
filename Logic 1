...
def squirrel(cigars, is_weekend):
...
def alarm_clock(day, vacation):
  return '7:00' if day in range(1,6) and not vacation else '10:00'if (day in range(1,6) and vacation) or (day in (0,6) and not vacation) else 'off';
...
def in1to10(n, outside_mode):
  return (n>=10 and outside_mode) or (n<=1 and outside_mode) or (n in range(1,11) and not outside_mode)
---------------------------------------
9.near_ten
